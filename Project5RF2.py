...
# ========== Step 4: Plotting Random Forest Results ==========
import matplotlib.pyplot as plt
import seaborn as sns

print("\n" + "="*60)
print("RANDOM FOREST MULTI-HORIZON VISUALIZATION")
print("="*60)

# Display the performance summary table
print("\nPerformance Summary Across All Horizons:")
print("-" * 50)
...
fig.suptitle('Random Forest Performance Across Market Impact Horizons', fontsize=16, fontweight='bold')
...
axes[0, 0].set_title("Random Forest Accuracy Across Market Impact Horizons", fontweight='bold')
...
for i, (x, y) in enumerate(zip(performance_summary_df['Horizon'], performance_summary_df['Accuracy'])):
    axes[0, 0].annotate(f'{y:.3f}', (x, y), textcoords="offset points", xytext=(0,10), ha='center', fontsize=8)

# Plot 2: F1 Scores for Buy and Sell
axes[0, 1].plot(performance_summary_df['Horizon'], performance_summary_df['F1_Buy'], 
                label='F1 Score (Buy)', marker='o', linewidth=2, markersize=8, color='green')
axes[0, 1].plot(performance_summary_df['Horizon'], performance_summary_df['F1_Sell'], 
                label='F1 Score (Sell)', marker='s', linewidth=2, markersize=8, color='red')
axes[0, 1].set_title("Random Forest F1 Scores for 'Buy' and 'Sell'", fontweight='bold')
...
axes[1, 0].set_title("Random Forest Precision for 'Buy' and 'Sell'", fontweight='bold')
...
# Plot 4: Performance Trends (Best vs Worst)
...
# Create a heatmap of all metrics across horizons
...
plt.title('Random Forest Performance Heatmap Across All Horizons', fontweight='bold', fontsize=14)
...
plt.title('Random Forest Performance Trends Across Time Horizons', fontweight='bold', fontsize=14)
